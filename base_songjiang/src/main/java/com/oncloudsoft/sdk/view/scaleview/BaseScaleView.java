package com.oncloudsoft.sdk.view.scaleview;
...
public abstract class BaseScaleView extends View {
    ...
    protected void init(AttributeSet attrs) {
        ...
        mMin = ta.getInteger(R.styleable.BaseScaleView_view_min, 0);
        mMax = ta.getInteger(R.styleable.BaseScaleView_view_max, 60*60*10);//1秒 有10刻度   12个小时
        mScaleMargin = ta.getDimensionPixelOffset(R.styleable.BaseScaleView_view_margin, 15);
        mScaleHeight = ta.getDimensionPixelOffset(R.styleable.BaseScaleView_view_height, 20);
        ta.recycle();
