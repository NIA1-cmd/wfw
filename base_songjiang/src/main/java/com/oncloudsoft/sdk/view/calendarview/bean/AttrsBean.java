package com.oncloudsoft.sdk.view.calendarview.bean;
...
//    private int[] disableStartDate;//单选时默认选中的年、月、日disableStar
    private List<String> diaenableDate;//不能选择的日期
...
//    }
    ...
    public List<String> getDiaenableDate() {
        return diaenableDate;
    }

    public void setDiaenableDate(List<String> diaenableDate) {
        this.diaenableDate = diaenableDate;
    }
}
