...
public class VoiceLineView extends View {
    ...
    private void initAtts(Context context, AttributeSet attrs) {
        ...
        if (mode == RECT) {
            rectWidth = typedArray.getDimension(R.styleable.VoiceLineView_rectWidth, 25);
            rectSpace = typedArray.getDimension(R.styleable.VoiceLineView_rectSpace, 5);
            rectInitHeight = typedArray.getDimension(R.styleable.VoiceLineView_rectInitHeight, 4);
        } else {
