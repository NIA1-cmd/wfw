package com.oncloudsoft.sdk.view.calendarview.weiget;
...
import com.oncloudsoft.sdk.view.calendarview.bean.AttrsBean;
import com.oncloudsoft.sdk.view.calendarview.bean.DateBean;
import com.oncloudsoft.sdk.view.calendarview.listener.CalendarViewAdapter;
import com.oncloudsoft.sdk.view.calendarview.listener.OnMultiChooseListener;
    ...
    public void setDateList(List<DateBean> dates, int currentMonthDays) {
        ...
        for (int i = 0; i < dates.size(); i++) {
            ...
            if (date.getType() == 1) {
                ...
                if (mAttrsBean.getDiaenableDate()!=null && mAttrsBean.getDiaenableDate().size()>0 && mAttrsBean.getDiaenableDate().contains(date.getSolar()[0]+"."+date.getSolar()[1]+"."+date.getSolar()[2])){
                    solarDay.setTextColor(mAttrsBean.getColorLunar());
                    lunarDay.setTextColor(mAttrsBean.getColorLunar());
                    view.setTag(-1);
                    addView(view, i);
...
//                if (mAttrsBean.getDisableStartDate() != null && (CalendarUtil.dateToMillis(mAttrsBean.getDisableStartDate()) > CalendarUtil.dateToMillis(date.getSolar()))) {
//                    solarDay.setTextColor(mAttrsBean.getColorLunar());
//                    lunarDay.setTextColor(mAttrsBean.getColorLunar());
//                    view.setTag(-1);
//                    addView(view, i);
...
//                if (mAttrsBean.getDisableEndDate() != null && (CalendarUtil.dateToMillis(mAttrsBean.getDisableEndDate()) < CalendarUtil.dateToMillis(date.getSolar()))) {
//                    solarDay.setTextColor(mAttrsBean.getColorLunar());
//                    lunarDay.setTextColor(mAttrsBean.getColorLunar());
//                    view.setTag(-1);
//                    addView(view, i);
