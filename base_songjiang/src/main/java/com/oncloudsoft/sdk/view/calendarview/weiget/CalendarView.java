...
import com.oncloudsoft.sdk.view.calendarview.utils.SolarUtil;
...
public class CalendarView extends ViewPager {
    ...
    private boolean isIllegal(int[] destDate) {
        ...
        if (mAttrsBean.getDiaenableDate() != null && mAttrsBean.getDiaenableDate().size() > 0) {
            mAttrsBean.getDiaenableDate().contains(destDate[0]+"."+destDate[1]+"."+destDate[2]);
            return false;
        }
...
//    }
     ...
     * 设置日历禁用时间
     *
     * @param disEnableDate 禁用startDate之前的日期
     * @return
     */
    public CalendarView setDisableDate(List<String> disEnableDate) {
        mAttrsBean.setDiaenableDate(disEnableDate);
//        mAttrsBean.setDisableStartDate(CalendarUtil.strToArray(startDate));
//        mAttrsBean.setDisableEndDate(CalendarUtil.strToArray(endDate));
        return this;
    }
