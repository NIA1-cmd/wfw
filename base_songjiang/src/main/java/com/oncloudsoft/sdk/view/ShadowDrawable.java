...
import static com.oncloudsoft.sdk.utils.SizeUtil.dpToPx;
...
public class ShadowDrawable extends Drawable {
    ...
    public  void setShadowDrawable(View view, Drawable drawable) {
        view.setLayerType(View.LAYER_TYPE_SOFTWARE, null);
        ViewCompat.setBackground(view, drawable);
    }

    public  void setShadowDrawable(View view, int shapeRadius, int shadowColor, int shadowRadius, int offsetX, int offsetY) {
    ...
    public  void setShadowDrawable(View view, int bgColor, int shapeRadius, int shadowColor, int shadowRadius, int offsetX, int offsetY) {
        ShadowDrawable drawable = new ShadowDrawable.Builder()
                .setBgColor(bgColor)
                .setShapeRadius(shapeRadius)
                .setShadowColor(shadowColor)
...
//            mShadowColor = Color.parseColor("#4d000000");
    ...
    public static void setPublicShadow(View view){
        ShadowDrawable.setShadowDrawable(view, ShadowDrawable.SHAPE_ROUND, Color.parseColor("#ffffff"), dpToPx(2), Color.parseColor("#104e81f8"), dpToPx(10), dpToPx(4), dpToPx(4));
