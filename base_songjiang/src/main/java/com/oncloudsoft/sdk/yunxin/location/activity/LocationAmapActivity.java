package com.oncloudsoft.sdk.yunxin.location.activity;
...
import com.oncloudsoft.sdk.yunxin.location.helper.NimGeocoder;
...
public class LocationAmapActivity extends UI implements AMap.OnCameraChangeListener, OnClickListener
        , NimLocationManager.NimLocationListener, BaseTitleView.onRightTextClickListener{
    ...
    private void initView() {
        ...
        mBtTitle.setRightTextVisibility(View.INVISIBLE);
        ...
        mBtTitle.setOnRightTextClickListener(this);
    ...
    private void updateSendStatus() {
        ...
        if (TextUtils.isEmpty(addressInfo)) {
            ...
            mBtTitle.setRightTextVisibility(View.GONE);

        } else {
            mBtTitle.setRightTextVisibility(View.VISIBLE);
        }
