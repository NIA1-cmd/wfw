...
import static com.oncloudsoft.sdk.yunxin.uikit.business.team.helper.TeamHelper.teamMemberComparator;
...
public class AdvancedTeamMemberActivity extends UI implements TAdapterDelegate,
    ...
    private void findViews() {
       TeamInfoGridView teamInfoGridView =  findViewById(R.id.team_member_grid);
    ...
    private void addTeamMembers(final List<TeamMember> m, boolean clear) {
        ...
        // sort
        Collections.sort(this.members, teamMemberComparator);
