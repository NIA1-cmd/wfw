package com.oncloudsoft.sdk.yunxin.uikit.business.chatroom.fragment;
...
import com.oncloudsoft.sdk.yunxin.uikit.business.ait.AitManager;
import com.oncloudsoft.sdk.yunxin.uikit.business.chatroom.helper.ChatRoomHelper;
import com.oncloudsoft.sdk.yunxin.uikit.business.chatroom.module.ChatRoomInputPanel;
import com.oncloudsoft.sdk.yunxin.uikit.business.chatroom.module.ChatRoomMsgListPanel;
...
import com.oncloudsoft.sdk.yunxin.uikit.common.fragment.TFragment;
                ...
                .setCallback(new RequestCallback<Void>() {
                    ...
                    public void onFailed(int code) {
                        if (code == ResponseCode.RES_CHATROOM_MUTED) {
                            ToastHelper.showToast(getActivity(), "用户被禁言");
                        } else if (code == ResponseCode.RES_CHATROOM_ROOM_MUTED) {
                            ToastHelper.showToast(getActivity(), "全体禁言");
                        } else {
                            ToastHelper.showToast(getActivity(), "消息发送失败：code:" + code);
                        }
                    }

                    @Override
                    public void onException(Throwable exception) {
                        ToastHelper.showToast(getActivity(), "消息发送失败！");
                    }
                });
