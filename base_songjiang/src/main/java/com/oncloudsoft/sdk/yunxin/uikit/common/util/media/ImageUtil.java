package com.oncloudsoft.sdk.yunxin.uikit.common.util.media;
...
import com.oncloudsoft.sdk.yunxin.uikit.business.session.viewholder.MsgViewHolderThumbBase;
...
public class ImageUtil {
    ...
    public static Boolean scaleImage(File srcFile, File dstFile, int dstMaxWH, CompressFormat compressFormat, int quality) {
        ...
        try {
            ...
            float rotate;
            String mimeType = com.oncloudsoft.sdk.yunxin.uikit.common.media.picker.util.BitmapUtil.getImageType(srcFile.getAbsolutePath());
