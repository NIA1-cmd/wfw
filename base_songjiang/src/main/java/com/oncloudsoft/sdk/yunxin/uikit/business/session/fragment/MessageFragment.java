...
import com.oncloudsoft.sdk.yunxin.uikit.business.session.actions.ImageAction;
import com.oncloudsoft.sdk.yunxin.uikit.business.session.actions.VideoAction;
...
import com.oncloudsoft.sdk.yunxin.uikit.business.session.module.list.MessageListPanelEx;
...
public class MessageFragment extends TFragment  implements ModuleProxy{
    ...
    private boolean canFastNotifycation=false;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //imageView = rootView.findViewById(R.id.iv_teammember);
        //快捷通知
...
// TODO: 2019/3/22   过滤消息的地方
            MyLog.d(JSON.toJSONString(m));
        }
