package com.oncloudsoft.sdk.yunxin.uikit.common.media.picker.adapter;
...
import com.oncloudsoft.sdk.yunxin.uikit.common.media.picker.fragment.PickerImageFragment;
import com.oncloudsoft.sdk.yunxin.uikit.common.media.picker.loader.PickerImageLoader;
import com.oncloudsoft.sdk.yunxin.uikit.common.media.picker.model.PhotoInfo;
import com.oncloudsoft.sdk.yunxin.uikit.common.media.picker.util.ThumbnailsUtil;
...
public class PickerPhotoAdapter extends BaseAdapter {
    ...
    public PickerPhotoAdapter(Activity context, List<PhotoInfo> list, GridView gridView,
        ...
        viewHolder.selectHotPot.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (photo.isChoose()) {
                    ...
                    ToastHelper.showToast(mContext, String.format(mContext.getResources().getString(R.string.picker_image_exceed_max_image_select), maxSelectSize));
                    return;
                }
