package com.oncloudsoft.sdk.yunxin.uikit.business.session.adapter;
...
import com.oncloudsoft.sdk.yunxin.uikit.business.session.viewholder.media.DateViewHolder;
import com.oncloudsoft.sdk.yunxin.uikit.business.session.viewholder.media.MediaViewHolder;
        ...
        if (getItemViewType(position) == ITEM_VIEW_TYPE_DATE) {
            ...
            if (msg.getMsgType() == MsgTypeEnum.image) {
                ...
                ((MediaViewHolder) holder).mediaImage.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        WatchVideoActivity2.start(context, msg,"", false);
                    }
                });
            }
        }
