package com.oncloudsoft.sdk.yunxin.uikit.business.robot.model;
...
public class RobotResponseContent implements Serializable {
    ...
    private List<com.netease.nim.uikit.business.robot.model.RobotBotContent> botContents;

    private List<com.netease.nim.uikit.business.robot.model.RobotFaqContent> faqContents;
    ...
    public List<com.netease.nim.uikit.business.robot.model.RobotBotContent> getBotContents() {
        return botContents;
    }

    public List<com.netease.nim.uikit.business.robot.model.RobotFaqContent> getFaqContents() {
        return faqContents;
    }
    ...
    public String getMaxScoreFaqContent() {
        ...
        int maxScore = -1;
        com.netease.nim.uikit.business.robot.model.RobotFaqContent result = null;

        for (com.netease.nim.uikit.business.robot.model.RobotFaqContent faqContent : faqContents) {
        ...
        if (flag.equals(FLAG_BOT)) {
            ...
            if (msgArray != null && msgArray.size() >= 0) {
                ...
                for (int i = 0; i < msgArray.size(); i++) {
                    ...
                    com.netease.nim.uikit.business.robot.model.RobotBotContent content = new com.netease.nim.uikit.business.robot.model.RobotBotContent(botMsg, type);
            ...
            if (array != null && array.size() >= 0) {
                ...
                for (int i = 0; i < array.size(); i++) {
                    ...
                    com.netease.nim.uikit.business.robot.model.RobotFaqContent content = new com.netease.nim.uikit.business.robot.model.RobotFaqContent(faqMsg, score);
