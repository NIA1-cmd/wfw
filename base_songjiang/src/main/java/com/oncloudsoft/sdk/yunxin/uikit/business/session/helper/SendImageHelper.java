...
public class SendImageHelper {
    ...
    public static void sendImageAfterSelfImagePicker(Activity context, Intent data, final Callback callback) {
        boolean isOrig = data.getBooleanExtra(Extras.EXTRA_IS_ORIGINAL, false);
    ...
    public static class SendImageTask extends AsyncTask<Void, Void, File> {
        ...
        public SendImageTask(Activity context, boolean isOrig, PhotoInfo info, Callback callback) {
