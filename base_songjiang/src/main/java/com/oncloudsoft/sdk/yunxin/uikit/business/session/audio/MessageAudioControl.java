...
import com.oncloudsoft.sdk.yunxin.uikit.common.media.audioplayer.BaseAudioControl;
...
public class MessageAudioControl extends BaseAudioControl<IMMessage> {
    ...
    private void startPlayAudio(
        ...
        if (StorageUtil.isExternalStorageExist()) {
            ...
            ToastHelper.showToast((Activity) mContext, R.string.sdcard_not_exist_error);
        }
    }
