...
import com.oncloudsoft.sdk.yunxin.uikit.business.robot.model.RobotResponseContent;
import com.oncloudsoft.sdk.yunxin.uikit.business.robot.parser.elements.base.Element;
...
import com.oncloudsoft.sdk.yunxin.uikit.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<com.oncloudsoft.sdk.yunxin.uikit.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (com.oncloudsoft.sdk.yunxin.uikit.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
