...
public abstract class MsgViewHolderThumbBase extends MsgViewHolderBase {
    ...
    protected void bindContentView() {
        ...
        if (!TextUtils.isEmpty(thumbPath)) {
            ...
            isChart(false);
            GlidelUtil.loadImag((Activity) context,url,getImageMaxEdge(),getImageMaxEdge(),thumbnail);
//            loadThumbnailImage(url, true, msgAttachment.getExtension());
//
        } else {
    ...
    protected abstract void isChart(boolean isChart);
}
