...
import com.oncloudsoft.sdk.yunxin.uikit.business.contact.core.item.LabelItem;
...
public abstract class AbsContactDataList {
    protected final com.oncloudsoft.sdk.yunxin.uikit.business.contact.core.model.ContactGroupStrategy groupStrategy;
    ...
    public AbsContactDataList(com.oncloudsoft.sdk.yunxin.uikit.business.contact.core.model.ContactGroupStrategy groupStrategy) {
    ...
    protected static final class Group {
        ...
        void add(AbsContactItem add) {
           /* if (add instanceof Comparable) {
                addComparable((Comparable<AbsContactItem>) add);  //默认排序
            } else {*/
                items.add(add);
            //}
        }
