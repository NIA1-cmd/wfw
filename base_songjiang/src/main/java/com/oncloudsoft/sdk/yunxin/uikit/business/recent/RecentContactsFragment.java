package com.oncloudsoft.sdk.yunxin.uikit.business.recent;
...
import com.oncloudsoft.sdk.yunxin.uikit.common.ui.recyclerview.listener.SimpleClickListener;
...
import static com.oncloudsoft.sdk.yunxin.uikit.business.recent.TeamMemberAitHelper.isAitMessage;
import static com.oncloudsoft.sdk.yunxin.uikit.business.recent.TeamMemberAitHelper.setRecentContactAited;
...
//                        && r.getSessionType()==SessionTypeEnum.Team  //只有群消息，没有私聊的消息
            ...
            if (r.getSessionType() == SessionTypeEnum.Team && cacheMessages.get(r.getContactId()) != null) {
                setRecentContactAited(r, cacheMessages.get(r.getContactId()));
            }
        }
        ...
        NIMClient.getService(MsgService.class).queryMessageListEx(anchor, QueryDirectionEnum.QUERY_OLD,
            ...
            public void onResult(int code, List<IMMessage> result, Throwable exception) {
                if (code == ResponseCode.RES_SUCCESS && result != null) {
                    ...
                    // 更新并展示
                    if (messages != null) {
                        setRecentContactAited(recentContact, messages);
                        notifyDataSetChanged();
                    }
                }
            }
