...
import com.oncloudsoft.sdk.yunxin.location.adapter.IconListAdapter;
import com.oncloudsoft.sdk.yunxin.location.helper.MapHelper;
    ...
    public void onLocationChanged(NimLocation location) {
        if (location != null && location.hasCoordinates()) {
            if (firstLocation) {
                ...
                // 缩放到可见区
                int boundPadding = getResources().getDimensionPixelSize(R.dimen.unit_80);
